...
func ParseExpressionSafe(parser *Parser, ss *StringScanner, cache map[string]interface{}) (interface{}, error) {
...
func innerParse(markup string, ss *StringScanner, cache map[string]interface{}) (interface{}, error) {
	...
	// blank y empty son símbolos especiales — retornan el string literal,
	// no se buscan como variables. isBlankSymbol() en condition.go los reconoce.
